<div class="card">
    <div class="card-header">
        <img src="{{ $post->owner->image }}" alt="profile image" class="w-9 h-9 mr-3 rounded-full">
    ...
    <div class="card-body">
        ...
        <div class="p-3">
            <a href="/p/{{ $post->slug }}/like">
                ...
                @else
                <i class="bx bx-heart text-3xl hover:text-gray-500 cursor-pointer mr-3"></i>
                @endif
            </a>
        </div>
        <div class="p-3">
        ...
        @endif
        <div class="p-3 text-gray-500 uppercase text-xs">
