        ...
        <div class="hidden w-[60rem] lg:flex lg:flex-col pt-4">
            <div class="flex flex-row text-sm ">
                ...
                <div class="flex flex-col">
                    <a href="/{{ auth()->user()->username }}" class="font-bold dark:text-white">
                        {{ auth()->user()->username }}
                    </a>
            ...
            {{-- Suggested Users --}}
            <div class="mt-5">
                <h3 class="text-gray-500 font-bold dark:text-white">{{ __('Suggestions For You') }}</h3>
                <ul>
                    @foreach ($suggested_users as $suggested_user)
                        <li class="flex flex-row my-5 text-sm justify-items-center items-center dark:text-white">
                            <div class="ltr:mr-5 rtl:ml-5">
