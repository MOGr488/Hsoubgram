    ...
    <div class="text-3xl mb-3 dark:text-gray-300">
        ...
        @if($user->id === auth()->id())
            <a href="/{{$user->username}}/edit"
               class="w-44 border text-sm font-bold py-1 rounded-md border-neutral-300 text-center dark:text-gray-300">
                {{__('Edit Profile')}}</a>
        @endif
    </div>
...
{{--User stats--}}
    ...
    <ul class="text-sm flex-col flex-row justify-around md:justify-start md:-space-x-10 md:text-xl">
